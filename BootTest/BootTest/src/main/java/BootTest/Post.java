...
public class Post {
	/**
	 * L'ID du Post. Cet ID n'est pas modifiable. Il est gere par mongodb.
	 * 
	 * @see Post#getId()
	 */
	@Id
	...
	/**
	 * La date de creation du Post. La date de creation est attribuee
	 * definitivement.
	 * 
	 ...
	 * <p>
	 * A la construction d'un objet Post, le titre, l'auteur et le contenu est
	 * fixe par defaut. La date de creation est fixee a la date courante.
	 * </p>
	 * 
	 * @see Post#id
	 * @see Post#title
	 ...
	 * <p>
	 * A la construction d'un objet Post, la date de creation est fixee a la
	 * date courante.
	 * </p>
	 * 
	 * @param title
